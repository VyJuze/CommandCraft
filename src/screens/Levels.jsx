...
<div className="min-h-screen bg-fondo p-8">
  ...
  <div className="mb-10">
    ...
    >
      There are four categories to explore, each with its own set of challenges. Choose one to start your journey in mastering Minecraft commands.
    </motion.p>
  </div>
        ...
        {categories.map((category) =>{
          return (
            <LevelCard
              ...
              xpEarned={getTotalXpByCategory(state.completedExercises, category)}
            />
          )
        })}
